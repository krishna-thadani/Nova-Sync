...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: "Debt", path: "/debt", icon: Activity },
              ...
              {!user ? (
                ...
                <>
                  <button
                    ...
                    className="p-2.5 rounded-xl border border-soft text-[#4eb7b3] hover:bg-[#d0f6e3]/50 transition-colors focus:outline-none flex items-center justify-center mr-2 shadow-sm relative group"
                    title="NovaSync Mentor"
                  >
                    <Sparkles size={18} />
                  ...
                  {!user ? (
                    ...
                    <>
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border border-soft text-[#4eb7b3] font-medium hover:bg-[#d0f6e3]/50 transition-colors"
                      >
                        <Sparkles size={18} />
                        NovaSync Mentor
                      </button>
