    ...
    <div className="min-h-screen w-full max-w-[1440px] mx-auto px-6 py-10 space-y-12">
      ...
      <div className="text-center max-w-3xl mx-auto">
        <h1 className="text-4xl md:text-5xl font-bold text-main">
          About <span className="text-primary">NovaSync</span>
        </h1>
      ...
      <section className="max-w-5xl mx-auto card p-6">
        ...
        <p className="text-muted leading-relaxed">
          NovaSync is a productivity tool designed to help you plan your tasks in a clear and structured way.
    ...
    {[
      ...
      <section className="text-center max-w-3xl mx-auto">
        ...
        <h3 className="mt-2 text-xl font-semibold text-primary">
          NovaSync helps you stay focused, not overwhelmed.
        </h3>
      </section>
